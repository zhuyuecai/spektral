...
class SGCNConv(Conv):
    r"""
    the basic module to apply spatial graph convolutional for a ST-GCN layer
    ...
    **Output**
    ...
    dimension changed to `channels`. ([batch], n_nodes, n_channels)

    **Arguments**

    - `channels`: number of output channels;or number of feature maps
